                    ...
                    <div class="modal-content">
                        ...
                        <form action="action">
                            <div class="modal-body">
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Empresa</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Contacto</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">RUC</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Telefono</label>
                                    <input type="number" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Direccion</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Creacion</label>
                                    <input type="date" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example3" class="display table header-border table-hover verticle-middle" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th class="text-primary text-center">Empresa</th>
                                            <th class="text-primary text-center">Contacto</th>
                                            <th class="text-primary text-center">Ruc</th>
                                            ...
                                            <th class="text-primary text-center">Creador</th>
