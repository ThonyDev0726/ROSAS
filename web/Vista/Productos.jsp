                    ...
                    <div class="modal-content">
                        ...
                        <form action="action">
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Tallos</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Mallas</label>
                                    <input type="text" name="password" class="form-control" id="yourPassword" required>                                    
                                </div>
                                <div class="col-12">
                                    <label for="yourPassword" class="form-label">Proveedor</label>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example3" class="display table header-border table-hover verticle-middle" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th class="text-primary text-center">Descripccion</th>
                                            <th class="text-primary text-center">Tallos</th>
                                            <th class="text-primary text-center">Mallas</th>
                                            <th class="text-primary text-center">Proveedor</th>
                                            <th class="text-primary text-center">Accion</th>                                                    
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">Descripccion</td>    
                                            <td class="text-center">Tallos</td>  
                                            <td class="text-center">Mallas</td>  
